...
'''3. Write a function euros_to_pounds which converts an amount in Euros entered
...
'''4. Write an add_up function that asks the user to enter two numbers,
...
'''6. Write a ten_hellos function that uses a loop to display “hello, world!”
...
'''7. Change the count function so that instead of counting from 0 to 9,
it counts up from 1 to 10. (Hint: Use a little arithmetic in the print
statement.) '''
...
'''8. [harder] Write a function weights_table that outputs a two-column table
of kilogram weights and their pound equivalents for kilogram values 0, 10,
20 ... 100. (Don’t worry too much about formatting the table neatly.) '''
...
'''9. [harder] Write a future_value function that uses a loop to calculate
the future value of an investment amount, assuming an annual interest rate of
5.5%. The function should ask the user for the initial amount and the number
of years that it is to be invested, and should output the final value of the
investment using compound interest with the interest compounded every year. '''
