'''
6.
Create a class called ”Lecturer”. The lecturer class will need to hold the
...
__init__(self ,first_name, last_name, salary, units_taught) - where
units_taught is a list. The university needs to be able to:
...
lecturer1 = Lecturer("John", "Doe", 70000, [
                     "Robotics", "Databases", "Machine learning"])
